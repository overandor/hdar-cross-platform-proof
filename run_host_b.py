...
def main() -> int:
    ...
    ap.add_argument("--sandbox-id", default="", help="E2B sandbox ID (passed by run_proof.py when running inside E2B)")
    args = ap.parse_args()
    ...
    report = {
        ...
        "e2b_sandbox_id": args.sandbox_id if args.sandbox_id else None,
